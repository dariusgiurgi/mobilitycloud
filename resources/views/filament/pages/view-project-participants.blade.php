...
{{-- Stats --}}
    ...
    @if($showImportModal)
        <div style="position:fixed;inset:0;z-index:50;background:rgba(0,0,0,.6);display:flex;align-items:center;justify-content:center;padding:1rem;"
            ...
            <div class="mc-part-modal" style="width:100%;max-width:480px;border-radius:14px;padding:1.5rem;box-shadow:0 20px 50px rgba(0,0,0,.4);background:#fff;">
                <h3 class="text-gray-950 dark:text-white" style="font-size:17px;font-weight:600;margin:0 0 .5rem;">Import participants</h3>
                <p class="text-gray-500 dark:text-gray-400" style="font-size:12px;line-height:1.5;margin:0 0 1rem;">
                    Upload a CSV generated by MobilityCloud. First name and Last name are required. The import is limited to 1,000 rows and is cancelled entirely if a row is invalid.
                </p>
                <input type="file" wire:model="importFile" accept=".csv,text/csv" class="text-gray-700 dark:text-gray-200" style="width:100%;font-size:13px;">
