<x-filament-panels::page>
    ...
    @php
        ...
        $projectMobilities = $this->getProjectMobilities();
...
{{-- Stats --}}
        ...
        <div class="mc-modal-backdrop"
            ...
            <div class="mc-part-modal mc-modal-panel"><div class="mc-modal-body">
                ...
                <p class="mc-modal-description">
                    Upload a CSV generated by MobilityCloud. Complete name is required. Dates may use YYYY-MM-DD, DD.MM.YYYY or DD/MM/YYYY; Excel date serials are also accepted. The import is limited to 1,000 rows and is cancelled entirely if a row is invalid.
                </p>
    ...
    <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10"
        ...
        <div style="display:flex;gap:1rem;flex-wrap:wrap;align-items:flex-end;">
            ...
            @if($projectMobilities->isNotEmpty())
                <div style="display:flex;flex-direction:column;gap:5px;">
                    <label class="text-gray-500 dark:text-gray-400" style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.04em;">Mobility</label>
                    <select wire:model.live="filterMobilityId" class="mc-part-in" style="width:auto;min-width:160px;background:transparent;">
                        <option value="">All mobilities</option>
                        @foreach($projectMobilities as $mobility)
                ...
                <table style="width:100%;border-collapse:collapse;font-size:13px;min-width:760px;">
                    <thead>
                        <tr class="text-gray-500 dark:text-gray-400" style="background:rgba(100,116,139,.06);font-size:10px;text-transform:uppercase;letter-spacing:.04em;">
                            ...
                            <th style="padding:10px 12px;text-align:left;">Mobilities</th>
                    ...
                    <tbody>
                        ...
                        <tr wire:key="part-{{ $p->id }}" class="text-gray-950 dark:text-white"
                            ...
                            <td style="padding:9px 12px;min-width:180px;" class="text-gray-500 dark:text-gray-400">
                                @if($p->mobilities->isEmpty())
    ...
    <div class="mc-modal-backdrop mc-modal-top"
        ...
        <div class="mc-part-modal mc-modal-panel mc-modal-panel-wide"><div class="mc-modal-body">
            ...
            <div class="mc-part-grid">
                <div>
                    <label class="mc-part-lbl">Complete name *</label>
                    <input type="text" wire:model="data.complete_name" class="mc-part-in" aria-label="Participant complete name">
                    @error('data.complete_name') <span class="mc-part-err">{{ $message }}</span> @enderror
                </div>
                <div>
                ...
                <div>
                    <label class="mc-part-lbl">Default role</label>
            ...
            <div class="mc-part-grid">
                <div>
                    <label class="mc-part-lbl">Organisation / group {{ count($partnerOrgs) > 0 ? '*' : '' }}</label>
                    ...
                    @else
                        <input type="text" wire:model="data.partner_organisation" class="mc-part-in" aria-label="Participant organisation"
                               placeholder="Add organisations in Project settings first">
                    @endif
                    @error('data.partner_organisation') <span class="mc-part-err">{{ $message }}</span> @enderror
                </div>
                <div>
