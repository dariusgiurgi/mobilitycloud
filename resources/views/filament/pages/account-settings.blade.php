                ...
                <x-filament::section heading="Personal details" description="These details belong to your account and follow you across every project." icon="heroicon-o-identification">
                    <div class="mc-account-fields">
                        <div class="mc-account-field">
                            ...
                            <input id="account-name" type="text" wire:model.live.debounce.800ms="name" class="text-gray-950 dark:text-white">
                            @error('name')<p class="mc-muted" style="font-size:.68rem;margin-top:.25rem;color:#dc2626;">{{ $message }}</p>@enderror
                        </div>
                        <div class="mc-account-field">
                            <label for="account-email">Email</label>
                            <input id="account-email" type="email" wire:model.live.debounce.800ms="email" class="text-gray-950 dark:text-white">
                    ...
                    <x-filament::section heading="Billing details" description="Required before creating owned projects. These are the fiscal details used for approved-project invoices." icon="heroicon-o-building-office-2">
                        <div class="mc-account-fields">
                            <div class="mc-account-field">
                                ...
                                <input id="billing-name" type="text" wire:model.live.debounce.800ms="billingName" class="text-gray-950 dark:text-white" placeholder="Organisation or person">
                            ...
                            <div class="mc-account-field">
                                ...
                                <input id="billing-vat" type="text" wire:model.live.debounce.800ms="billingVat" class="text-gray-950 dark:text-white" placeholder="Optional">
                                @error('billingVat')<p style="font-size:.68rem;margin-top:.25rem;color:#dc2626;">{{ $message }}</p>@enderror
                            </div>
                            <div class="mc-account-field">
                                <label for="billing-country">Country</label>
                                <input id="billing-country" type="text" wire:model.live.debounce.800ms="billingCountry" class="text-gray-950 dark:text-white" placeholder="Romania">
                                @error('billingCountry')<p style="font-size:.68rem;margin-top:.25rem;color:#dc2626;">{{ $message }}</p>@enderror
                            </div>
                            <div class="mc-account-field mc-account-field-full">
                                <label for="billing-address">Billing address</label>
                                <textarea id="billing-address" wire:model.live.debounce.800ms="billingAddress" class="text-gray-950 dark:text-white" placeholder="Street, number, city, postal code"></textarea>
                ...
                >
                    <div class="mc-account-fields">
                        <div class="mc-account-field">
                            ...
                            <select id="default-landing" wire:model.live="defaultLanding" class="text-gray-950 dark:text-white">
                        ...
                        <div class="mc-account-field">
                            ...
                            <select id="interface-density" wire:model.live="interfaceDensity" class="text-gray-950 dark:text-white">
                        ...
                        <div style="margin-top:1rem;">
                            @foreach([
                                ...
                                <label class="mc-account-row">
                                    ...
                                    <input type="checkbox" wire:model.live="{{ $model }}" class="mc-switch" aria-label="{{ $label }}">
                                </label>
                            @endforeach
                        </div>
                    @endunless
