            ...
            <div class="mc-platform-card">
                ...
                @forelse($endingSoon as $workspace)
                    <div class="mc-platform-row">
                        ...
                        <div class="mc-platform-muted">{{ ($workspace->subscription_ends_at ?: $workspace->trial_ends_at)?->format('d M') ?? 'Now' }}</div>
                    </div>
                @empty
                    <p class="mc-platform-muted" style="margin-top:.7rem;">No access deadlines or blocked workspaces need attention.</p>
                @endforelse
            </div>
            <div class="mc-platform-card">
