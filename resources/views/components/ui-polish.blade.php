@once
    <style>
        ...
        .mc-lock-badge { display:inline-flex;align-items:center;gap:.35rem;border-radius:999px;background:var(--mc-lock-color);color:#fff;font-size:.62rem;font-weight:850;line-height:1.2;white-space:nowrap;box-shadow:0 10px 24px var(--mc-lock-shadow); }
        .mc-lock-badge::before { content:'';width:.42rem;height:.42rem;border-radius:999px;background:#fff;box-shadow:0 0 0 2px rgba(255,255,255,.35); }
        .mc-lock-badge-floating { position:absolute;top:-.82rem;right:.9rem;z-index:5;padding:.28rem .66rem; }
        .mc-lock-badge-inline { position:static;padding:.22rem .54rem;font-size:.58rem;line-height:1.15;box-shadow:none; }
        .mc-lock-frame { position:relative; }
