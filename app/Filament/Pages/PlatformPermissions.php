...
class PlatformPermissions extends Page
{
    ...
    public function permissions(): array
    {
        return [
            ...
            ['area' => 'Support', 'permission' => 'Add account support notes', 'owner' => true, 'admin' => true],
            ['area' => 'Billing & access', 'permission' => 'View subscriptions and billing readiness', 'owner' => true, 'admin' => true],
            ['area' => 'Billing & access', 'permission' => 'Activate, suspend or expire account subscriptions', 'owner' => true, 'admin' => true],
            ['area' => 'Billing & access', 'permission' => 'Grant manual access outside subscription rules', 'owner' => true, 'admin' => false],
            ['area' => 'Billing & access', 'permission' => 'Create demo accounts and review demo reset status', 'owner' => true, 'admin' => false],
